...
int main() {
    ...
    printf("o PIB é: %f\n", pibpercapta1);
    superpoder1 = (float) populacao1 + area1 + (float) pontosTuristicos1 + pib1 + pibpercapta1 + 1.0f  / densidadepopulacional1;
    ...
    printf("o PIB é: %f\n", pibpercapta2);
    superpoder2 = (float) populacao2 + area2 + (float) pontosturisticos2 + pib2 + pibpercapta2 + 1.0f / densidadepopulacional2;
    printf(" super poder e: %.2f \n\n", superpoder2);
